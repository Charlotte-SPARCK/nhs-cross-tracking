...
const breakpoints = [];
const width = document.body.offsetWidth; // Throttle the watcher on resize
...
function closeMobileMenu() {
  ...
  mobileMenuToggleButton.focus(); // remove event listener for close icon

  mobileMenuCloseButton.removeEventListener('click', closeMobileMenu); // remove event listerer for esc key
...
function openMobileMenu() {
  ...
  mobileMenuToggleButton.setAttribute('aria-expanded', 'true'); // add event listerer for esc key to close menu

  document.addEventListener('keydown', handleEscapeKey); // add event listener for close icon to close menu
...
calculateBreakpoints();
updateNavigation();
doOnOrientationChange(); // Event listeners
...
mobileMenuToggleButton.addEventListener('click', toggleMobileMenu); // function cookieToggle() {
